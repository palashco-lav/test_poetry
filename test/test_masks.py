...
def test_get_mask_card_number_fixture(fix_mask):
...
def test_get_mask_card_number_empy():
...
def test_get_mask_account_fixture(fix_mask):
    """Проверка работы фикстурой"""
    assert get_mask_account(fix_mask) == "**2345"

def test_get_mask_account_empy():
